...
export class DomGameObject extends EventEmitter {
    ...
    `;
        ...
        if (this.#lt.alpha.dirty)
            this._container.style.opacity = this.#lt.alpha.v.toString();
    ...
    set x(v) { this.#lt.x.v = v; }
    get y() { return this.#lt.y.v; }
    set y(v) { this.#lt.y.v = v; }
    get pivotX() { return this.#lt.pivotX.v; }
    set pivotX(v) { this.#lt.pivotX.v = v; }
    get pivotY() { return this.#lt.pivotY.v; }
    set pivotY(v) { this.#lt.pivotY.v = v; }
    get scale() { return this.#lt.scaleX.v; }
    set scale(v) { this.#lt.scaleX.v = v; this.#lt.scaleY.v = v; }
    get scaleX() { return this.#lt.scaleX.v; }
    set scaleX(v) { this.#lt.scaleX.v = v; }
    get scaleY() { return this.#lt.scaleY.v; }
    set scaleY(v) { this.#lt.scaleY.v = v; }
    get rotation() { return this.#lt.rotation.v; }
    set rotation(v) { this.#lt.rotation.v = v; }
    get alpha() { return this.#lt.alpha.v; }
    set alpha(v) { this.#lt.alpha.v = v; }
    get drawOrder() { return Number(this._container.style.zIndex); }
    set drawOrder(v) { this._container.style.zIndex = v.toString(); }
}
